...
== Version 3.0.0 (May xx, 2010)

* Using Rich-CMS v3.1.0
* Using Rich-i18n v1.4.0
* Using Rich-pluralization v1.0.7
* Made E9s a bit more legend: GemSuited up! ^^
* Dropped Jeweler for Bundler
* Removed plugin related code

== Version 2.2.7 (November 24, 2010)

* Using Rich-CMS v2.1.7 and higher

== Version 2.2.6 (November 24, 2010)

* Using Rich-CMS v2.1.6 and higher
* Going back to the Haml gem instead of Sass

== Version 2.2.5 (November 16, 2010)

* Using Rich-CMS v2.1.5 and higher

== Version 2.2.4 (November 16, 2010)

* Using Rich-CMS v2.1.4 and higher

== Version 2.2.3 (November 13, 2010)

* Using Rich-i18n v1.3.4 and higher
