...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rich_cms>, [">= 2.1.0"])
      s.add_runtime_dependency(%q<rich_i18n>, [">= 1.3.0"])
      s.add_runtime_dependency(%q<rich_pluralization>, [">= 1.0.7"])
    else
      s.add_dependency(%q<rich_cms>, [">= 2.1.0"])
      s.add_dependency(%q<rich_i18n>, [">= 1.3.0"])
      s.add_dependency(%q<rich_pluralization>, [">= 1.0.7"])
    end
  else
    s.add_dependency(%q<rich_cms>, [">= 2.1.0"])
    s.add_dependency(%q<rich_i18n>, [">= 1.3.0"])
